...
class GUIhelper:
    ...
    def regWindow(self,f):
        ...
        self.label2=Label(self._root, text="Register yourself below", bg="#fd5068",fg="#fff")
        self.label2.configure(font=("Verdana", 12, "bold"))
        ...
        label5=Label(self._root, text="Password", bg="#fd5068",fg="#fff")
        ...
        label6=Label(self._root, text="City", bg="#fd5068",fg="#fff")
        ...
        label7=Label(self._root, text="Gender", bg="#fd5068",fg="#fff")
        ...
        label8=Label(self._root, text="Age", bg="#fd5068",fg="#fff")
    ...
    def mainWindow(self,other,data,mode,num=0):
        ...
        helpmenu = Menu(menu)
        menu.add_cascade(label="Proposal", menu=helpmenu)
        ...
        label1.configure(font=("Constantia", 16, "bold"))
        label1.pack(pady=(30, 10))

        city = "From: " + data[0][-1]
        label2 = Label(self._root, text=city, bg="#fff", fg="#000")
        label2.configure(font=("Constantia", 16, "bold"))
        label2.pack(pady=(10, 10))

        gender = "Not interested in " + data[0][4]
        label3 = Label(self._root, text=gender, bg="#fff", fg="#000")
        ...
        if mode==2:
            ...
            btn2 = Button(frame, text="Propose", fg="#fff", bg="#000",command=lambda :other.propose(data[0][0]))
            btn2.pack(side=LEFT)
